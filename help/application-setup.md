...
1. 在“图像预设”屏幕中，选择表中的某个预设，然后执行以下任一操作：
   ...
   * 单击&#x200B;**删除**&#x200B;以从列表中删除预设。
   * 取消选中预设名称旁的“活动”复选框，将其从MediaPortal用户的整个Dynamic Media经典用户界面中删除。
...
有关如何将响应式查看器嵌入到网页上的详细信息，请参阅&#x200B;*Adobe图像服务API帮助*&#x200B;中的[响应式静态图像库](https://marketing.adobe.com.com/resources/help/en_US/s7/is_ir_api/is_api/c_about_responsive_static_image_library.html)。
