...
**文件和文件夹** 选择要搜索的位置：在“所有文件和文件夹”中、“选定文件夹”中或“选定的文件夹和子文件夹”中。

**所有发布状态** “搜索已标记为准备发布、未标记为准备发布的文件”或所有文件。

**条件** 如果指定用于搜索的元数据条件，请选择搜索必须与所有条件（“全部”搜索）还是任何条件（“或”搜索）匹配。
...
**保存筛选器操作** 单击“选择预设”按钮，选择“将当前预设另存为新预设”，然后在“保存”对话框中输入名称。

**重复筛选操作** 单击“选择预设”按钮，然后在菜单上选择筛选操作的名称。 菜单将列出您所保存的过滤器操作。
...
**即时发布** ：在进行元数据更改时自动推送所有元数据更改，包括新资产、关键字更改等。

**XMP包发布** XMP包。 该数据包不能用于搜索，但可提供最新的 XMP。

**关键字** -将关键字发布到元数据服务器以用于搜索。
