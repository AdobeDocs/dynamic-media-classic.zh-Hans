...
uuid: 8153a228-b2 ec-4bc2-8996-266113a83 df5
contentOwner: admin
content-type: 引用
products: SG_ EXPERIENCE MANAGER/Dynamic-Media-Scene-7
geptopics: SG_ SCENESELEFERENDER_ PK/categories/image_ set
discoiquuid: 40f4abab-9059-4d92-a761-f6 d573 b42 e00
...
部署图像集最常见的方法是在网页上放置链接（通过导航图标）。单击该链接后，链接将启动在弹出缩放窗口中显示图像集的动态页面(JSP)。缩放链接会打开一个弹出窗口，其中包含实际的缩放功能。
