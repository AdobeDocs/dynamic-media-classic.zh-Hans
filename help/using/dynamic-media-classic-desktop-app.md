...
请参阅的常见问题解答 [新的Adobe Dynamic Media Classic登录体验现已推出。](/help/using/new-ui-2020.md)
...
欲了解完整的系统要求，请访问 [Adobe Dynamic Media Classic桌面应用程序的系统要求](/help/using/system-requirements.md).
