...
eCatalog 查看器预设决定了 eCatalog 查看器的样式、行为和外观。 Adobe Dynamic Media Classic包括eCatalog查看器预设，如果您拥有管理员访问权限，可以创建自定义预设。

要创建预设，您可以创建新预设或从Adobe Dynamic Media Classic提供的eCatalog查看器预设开始，然后以新名称保存预设。 要以公司的颜色显示打印材料并定义样式，您可以创建自己的eCatalog查看器预设。

eCatalog查看器预设为页面导航、缩放、搜索和选择“主题”提供了许多设置。 这些控件的外观和查看器的显示方式取决于您选择的eCatalog查看器预设。

**要设置eCatalog查看器预设（您必须具有管理员访问权限）：**

1. 在全局导航栏上，转到&#x200B;**[!UICONTROL 设置]** > **[!UICONTROL 查看器预设]**。
1. 在“查看器预设”屏幕中，通过创建新预设或从现有eCatalog查看器预设开始创建eCatalog查看器预设：
...
1. 在`Configure Viewer`页面上，设置所需的选项。
   ...
   如果要阅读选项的说明，请选择选项旁边的&#x200B;**[!UICONTROL 信息提示]**&#x200B;图标。

   当您更新和更改设置时，“预览”页面将显示查看器。

1. （可选）在&#x200B;**[!UICONTROL 信息面板设置]**&#x200B;中，**[!UICONTROL 信息服务器URL]**&#x200B;选项可以包含以下由查看器替换的特殊令牌。
...
1. （可选）在&#x200B;**[!UICONTROL 信息面板设置]**&#x200B;的&#x200B;**[!UICONTROL 响应模板]**&#x200B;框中，键入当Adobe Dynamic Media Classic在检索图像映射信息时遇到错误时要显示的文本。 例如，如果系统收到公司和eCatalog名称，但没有变换标识符，则会显示此消息。
...
1. 选择&#x200B;**[!UICONTROL 保存]**。
1. 选择&#x200B;**[!UICONTROL 默认]**，以便您创建的eCatalog查看器预设用于显示网页上的eCatalog。
