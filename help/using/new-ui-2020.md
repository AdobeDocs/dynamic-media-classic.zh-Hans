...
+++**_如何访问新的桌面应用程序？_**
新的桌面应用程序可用作macOS的`.dmg`安装程序。 `.exe`安装程序，用于Windows®。
...
>[!IMPORTANT]
>
>在给定计算机上，只能同时安装和激活桌面应用程序的一个实例。 但是，您可以跨计算机安装的数量没有限制。
...
+++**_此更改是否会影响我的自动化脚本？_**
不适用。 这对自动化脚本没有影响。 新桌面应用程序的功能类似于基于浏览器的体验。
+++

+++**_新的Adobe Dynamic Media Classic桌面应用能否在Mac和个人计算机上工作？_**
是。 这款新的桌面应用程序是一种跨平台解决方案，适用于Mac和PC。 不支持Linux®。
+++
...
某些公司不允许您未经批准将软件和应用程序下载并安装到您的系统中。 要获得访问新的Adobe Dynamic Media Classic桌面应用程序的权限，请提前与您的IT团队协调。 请记住，在2020年12月31日之后，浏览器版本已弃用。 请务必在截止日期前下载新的桌面应用程序。
+++

+++**_能否同时打开新桌面应用程序的多个实例？_**
不适用。 用于构建新Adobe Dynamic Media Classic桌面应用程序的Adobe® AIR®技术限制用户在给定时间打开该应用程序的多个实例。
+++
...
如果Adobe发布新版本的桌面应用程序，则客户必须下载并安装该应用程序（替换&#x200B;**[!UICONTROL 应用程序]**&#x200B;中的现有应用程序）。 您会通过Adobe客户团队和应用程序内升级通知机制收到新版本的通知，通知用户已升级。
+++
