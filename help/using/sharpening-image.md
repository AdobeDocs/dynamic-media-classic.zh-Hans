...
* **[!UICONTROL `Sharpen 2`]**  — 产生的结果比锐利一些 **[!UICONTROL 双三次]**，但图像服务器的CPU成本更高。
...
如果您未使用图像预设，也未沿URL字符串传递特定的图像服务器锐化协议，则在缩减像素取样时，图像不会进行锐化。 但是，如果缺乏锐化，您可以设置默认的锐化值，以确保任何图像始终具有某种锐化。
