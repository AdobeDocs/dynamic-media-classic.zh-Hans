...
您可以使用“预览”功能来显示使用不同eCatalog查看器预设的eCatalog。 要翻页、添加注释和浏览，可以使用不同的控件。
...
1. 在左侧的“资产库”面板的“显示”下拉列表中，选择基于eCatalog的资产类型，如eCatalog或eCatalog集。
1. 在左侧的资产库面板中，导航到包含要用eCatalog查看器预览的eCatalog的资产文件夹。
1. 执行以下任一操作：
