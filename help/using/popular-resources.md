...
* [图像提供和图像呈现API](https://experienceleague.adobe.com/zh-hans/docs/dynamic-media-developer-resources)
...
* [Adobe Dynamic Media Classic如何支持SEO](/help/using/assets/s7_seo.pdf)： Adobe Dynamic Media Classic优化搜索引擎的图像，以增加您网站的流量。 本PDF提供了实现这一目标的背景和实施指南。
...
* [使用Adobe Dynamic Media Classic提供交互式体验的最佳实践](https://seminars.adobeconnect.com/p7wb8ej3u6d/)：此网络研讨会教您如何使用Adobe Dynamic Media Classic导入和导出内容。 了解如何设置图像预设以获得最佳性能和体验。 您还可以了解查看器预设和缓存配置。
