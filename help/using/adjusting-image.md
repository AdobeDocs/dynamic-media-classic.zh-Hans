...
1. 使用`Adjust Editor`窗口右侧的命令，以便调整图像：
   ...
   * 使用`Colorize`选项对图像进行彩色化，同时保留阴影和高光。 对“彩色化”选项所做的更改也是累积的。 从“亮度”菜单中，选择&#x200B;**[!UICONTROL 无补偿]**，以便禁用自动亮度补偿。 将对比度值设置为 0 保持原始图像的对比度范围，或者指定值大于 0 的对比度范围。 值 100 将使对比度最大化。 典型值在30-70范围内。
