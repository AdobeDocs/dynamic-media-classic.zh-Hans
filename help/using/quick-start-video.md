...
* 显示嵌入到网页中的视频，在这种情况下，使用嵌入的代码功能。

  要获取视频的嵌入代码，请在“网格视图”或“列表视图”的“浏览”面板中选择视频。 转到&#x200B;**[!UICONTROL 预览]** > **[!UICONTROL 查看器列表]**。 在表的“操作”列下，选择`Universal_HTML5_Video`右侧的&#x200B;**[!UICONTROL 嵌入代码]**。 不允许编辑代码。

  选择&#x200B;**[!UICONTROL 关闭]**&#x200B;并将嵌入的代码粘贴到一个或多个网页中。

  >[!NOTE]
  >
  >仅在发布视频或自适应视频集后，才会激活嵌入的代码。
