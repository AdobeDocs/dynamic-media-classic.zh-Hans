...
要去除图像周围的空白区域或裁切图像的一个区域，您可以对其进行裁切。
...
1. 要裁切图像，请选择图像的变换图像&#x200B;**[!UICONTROL 编辑]**&#x200B;按钮，然后选择&#x200B;**[!UICONTROL 裁切]**，或在“浏览”面板详细信息视图中显示该图像，然后选择&#x200B;**[!UICONTROL 裁切]**&#x200B;按钮。
...
1. 要裁切图像，请选择图像的变换图像&#x200B;**[!UICONTROL 编辑]**&#x200B;按钮，然后选择&#x200B;**[!UICONTROL 裁切]**，或在“浏览”面板详细信息视图中显示该图像，然后选择&#x200B;**[!UICONTROL 裁切]**。

1. 在“裁切编辑器”窗口中，将要保留的图像部分放置在裁切框内。 选择&#x200B;**[!UICONTROL 保存]**&#x200B;并裁切图像后，框内显示的任何内容都会保留。
1. 要调整裁切区域，请执行以下任一操作：

   * 拖动框的一边或一角。 要更改裁切框的大小但保持其长宽比（形状），请在拖动时按住Shift键。
   * 在“大小”框中输入像素大小。
   * 拖动以移动裁切框。 将鼠标指针移动到该框边界内。 当看到移动指针时，将框拖动到图像上的新位置。
