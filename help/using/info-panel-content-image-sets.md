...
1. 在“响应模板”下拉列表中，执行下列操作之一：
   ...
   * 要创建您自己的响应模板，请选择&#x200B;**[!UICONTROL 自定义]**。 在“用户模板”文本框中，键入模板 XML 定义。 您可以使用文本框中已定义的默认模板作为自己响应的基础。

1. （可选）在默认响应框中，键入当Adobe Dynamic Media Classic在检索图像映射信息时遇到错误时要显示的文本。 例如，如果系统收到公司名称和图像集名称，但缺少变换标识符，则会向用户显示此消息。
