---
title: 搜索Dynamic Media Classic Assets
...
要在浏览时只查看特定类型的文件，请在左侧资产库的&#x200B;**[!UICONTROL 显示]**&#x200B;下拉列表中选择文件类型。 只有您选择显示的类型资产才会显示在资产库中。

>[!NOTE]
>
>如果“资产库”面板处于隐藏状态，请单击Dynamic Media Classic窗口正中的右三角形箭头以显示该面板。

## 在“浏览”面板中对文件排序 {#sorting-files-in-the-browse-panel}

您可以对“浏览”面板中显示的文件夹内容或搜索结果进行排序。 在“全局导航”栏上，选择&#x200B;**[!UICONTROL 排序]**，然后选择一个选项。 选项为&#x200B;**[!UICONTROL 名称]**、**[!UICONTROL 大小(KB)]**、**[!UICONTROL 类型]**、**[!UICONTROL 创建日期]**&#x200B;和&#x200B;**[!UICONTROL 上次修改时间]**。
...
1. 在资产库中“搜索”字段的左侧，选择&#x200B;**[!UICONTROL 搜索]**&#x200B;图标以打开下拉列表。
...
1. 在资产库中，选择&#x200B;**[!UICONTROL 筛选器]**&#x200B;选项卡。
   ...
   上一个过滤器操作的条件将显示在“过滤器”窗格中。 过滤器窗格分为多个面板，每个面板代表一个元数据字段。 可使用面板来选择要作为过滤条件的元数据字段，在每个字段内，选择一个要用于过滤器操作的元数据值。
...
* **[!UICONTROL 即时发布]**：在进行任何元数据更改时自动推送这些更改，包括新资源、关键词更改和其他相关项目。
