...
+++**是否需要升级准备清单中的所有步骤？**
否. 此 [就绪检查表](/help/using/upgrade-readiness.md) 包含必需和可选的最佳实践步骤。
...
请参阅 [功能比较](/help/using/upgrade-feature-comparison.md) 页面以了解详情。
...
另请参阅 [功能比较](/help/using/upgrade-feature-comparison.md) 页面以了解详情。
