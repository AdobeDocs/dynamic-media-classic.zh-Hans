...
seo-title: '"快速入门：模板基础"'
description: 'null'
seo-description: 模板基础知识的简介和快速开始，帮助您快速入门和使用。
...
模板可以包含任意数量的图像图层和文本图层。您可以将包含图层（如分层PSD文件）的静态文件转换为模板，并在Dynamic Media Classic中创建模板。 您可以使用上传到Dynamic Media Classic的字体在模板中创建文本图层。 将文本添加到模板中之后，可以通过更改其对齐方式、字体、字体大小以及颜色来设置字体格式。
...
如果构建模板时使用的是 PSD 文件，请在上载 PSD 文件时，从“上载作业选项”对话框中选择“创建模板”选项。还可以选择“图层命名”选项，告诉Dynamic Media Classic在将PSD图层上传到Dynamic Media Classic时如何命名这些图层。
