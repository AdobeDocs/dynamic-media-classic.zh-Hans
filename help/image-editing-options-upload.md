...
uuid: 0912ae6f-41c9-41b5-94d1-e266面部782e
contentOwner: admin
content-type: 引用
products: SG_ EXPERIENCE MANAGER/Dynamic-Media-Scene-7
geptopics: SG_ SCENESELEFERENDER_ PK/categories/master_ files
discoiquuid: d3f21cdf-2cb3-46e8-955a-b8 af0 b233 bc
...
**基于颜色修剪-** 仅当图像与您在图像角中选择的颜色完全匹配时，才可裁切像素。数字越接近 1，允许的色差越大。
...
| 半径 | 控制效果的半径。<br><br>值范围为0-250。该效果可在图像中的所有像素上运行，并从所有方向的所有像素放射出来。半径以像素为单位。例如，要使 2000 x 2000 像素图像和 500 x 500 像素图像具有类似的锐化效果，请在 2000 x 2000 像素图像上设置 2 个像素的半径值，而在 500 x 500 像素图像上设置 1 个像素的半径值。较大的值用于具有更多像素的图像。 |
