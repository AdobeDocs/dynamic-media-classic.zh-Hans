...
1. 执行以下任一操作：
   ...
   * **首先选择图像**  — 在“浏览”面板中，为图像集选择所需的图像，转到 **[!UICONTROL 构建]**  >  **[!UICONTROL 图像集]**。
...
1. 选择&#x200B;**[!UICONTROL Save]**，选择用于存储图像集的文件夹，输入图像集的名称，然后选择&#x200B;**[!UICONTROL Save]**。
1. 要在图像集查看器中查看图像集，请在图像集屏幕中选择&#x200B;**[!UICONTROL 预览]**。 您可以在图像集查看器中选择色板缩略图，以查看其行为方式。
...
1. 选择&#x200B;**[!UICONTROL Save]**，为集选择存储文件夹，输入集的名称，然后选择&#x200B;**[!UICONTROL Save]**。
