...
>[!NOTE]
>
>在创建优惠集之前，请确保发布要用于该集的所有资产，并将其设置为“Dynamic Media经典”。 请参阅[手动发布资源](publishing-files.md#manually_publishing_assets)和[手动取消发布资源](publishing-files.md#manually_unpublishing_assets)。
...
1. 为优惠集创建优惠并为不同图像选择图像预设后，请确保选中&#x200B;**保存**&#x200B;后发布（默认）。
