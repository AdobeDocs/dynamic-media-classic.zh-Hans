...
缩放查看器预设可确定缩放查看器的样式、行为和外观。Dynamic Media Classic优惠了许多用于自定义查看器和设置查看器外观的选项。 Dynamic Media Classic附带默认的基本（快速）、浮出和自定义缩放查看器预设。 如果您是管理员，则可以创建新的公司缩放查看器预设，或编辑默认预设并使用新名称保存。
...
Dynamic Media Classic建议在动态缩放查看器预设中使用以下参数：
